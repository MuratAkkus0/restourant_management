...
> = ({ isValid }) => {
  return (
    <>
      <p className="min-w-16 md:min-w-20 flex-shrink-0 flex items-center gap-1 text-xs md:text-base text-gray-500">
        <span
          className={`w-2 h-2 lg:w-3 lg:h-3 rounded-full ${isValid ? 'bg-green-600' : 'bg-red-600'}`}
        ></span>
